      ...
      <div className="md:py-20 w-full relative flex flex-col-reverse items-center md:grid grid-cols-2">
        <div className="max-w-[537px] md:max-w-none space-y-2 md:space-y-6 md:px-8 flex flex-col justify-center">
          ...
          <div className="pt-4 md:pt-0">
            <button className="btn-gradient w-full md:w-max px-6 py-2">
              Download app now!
            </button>
          </div>
        </div>
        <div className="w-full aspect-square mt-10 sm:mt-0">
          <div className="w-full sm:w-[90%] md:w-[72%] right-[50%] translate-x-[50%] md:translate-x-0 md:-right-[18%] md:-top-[20px] xl:-top-[100px] absolute aspect-square">
            <Image
